...
set _SETUP_UTIL=C:/Users/paolo/OneDrive/Documenti/Ricerca@UniPG/drones/matlab_msg_gen_ros1/win64/install/_setup_util.py
...
set _PYTHON="C:/msys64/mingw64/bin/python3.exe"
